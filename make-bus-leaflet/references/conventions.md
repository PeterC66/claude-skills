...
- **Resolution order for the estate**: `--buses`, then `BUSES_DIR`, then the laptop default. State it once, in the shared resolver — OA-224 Tier 3.1 is what makes that one function rather than eleven.
