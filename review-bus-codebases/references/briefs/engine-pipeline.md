...
- Orchestration and gates in `assets/`: `stage.js`, `status.js`, `gate_lib.js`, `gate.sh`, `rollout.js`, `rollout_places.js`, `quality_gate.js`, `quality_metrics.js`, `verify_report.js`, `redteam_source.js`, `sync_ci_reference.js`, `refresh_latest.js`, `refresh_area_fixture.js`, `build_log.js`, `strict_guards.js`, `stray_outputs.js`, `index_guard.js`, `seed_prev_s4.js`, `render.js`, `render_sweep.js`, `contact_sheet.js`, `crop_compare.js`, `preview_design.js`, `edit-server.js`, `diagram_edit.js`, `scratch.js`, `line_endings.js`, `adopt_config.js`, `curate_services.js`, `match_routes.js`, `derive_intown.js`, `pull_*.js`, `backfill_coords.js`, `freeze_orientation.js`, `poi_worksheet.js`, and anything added since.
